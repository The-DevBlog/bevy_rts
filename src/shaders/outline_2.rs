...
const SHADER_ASSET_PATH: &str = "shaders/outline_2.wgsl";

/// It is generally encouraged to set up post processing effects as a plugin
pub struct Outline2ShaderPlugin;

impl Plugin for Outline2ShaderPlugin {
    fn build(&self, app: &mut App) {
        app.register_type::<Outline2ShaderSettings>();
        app.add_plugins((
            ...
            ExtractComponentPlugin::<Outline2ShaderSettings>::default(),
            // The settings will also be the data used in the shader.
            // This plugin will prepare the component for the GPU by creating a uniform buffer
            // and writing the data to that buffer every frame.
            UniformComponentPlugin::<Outline2ShaderSettings>::default(),
        ));
...
impl ViewNode for PostProcessNode {
    ...
    type ViewQuery = (
        ...
        &'static Outline2ShaderSettings,
        // As there could be multiple post processing components sent to the GPU (one per camera),
        // we need to get the index of the one that is associated with the current view.
        &'static DynamicUniformIndex<Outline2ShaderSettings>,
    ...
    fn run(
        ...
        let settings_uniforms = world.resource::<ComponentUniforms<Outline2ShaderSettings>>();
        ...
        let layout = render_device.create_bind_group_layout(
            ...
            &BindGroupLayoutEntries::sequential(
                ...
                (
                    ...
                    uniform_buffer::<Outline2ShaderSettings>(true),
                    texture_depth_2d(),
                    texture_2d(TextureSampleType::Float { filterable: true }),
...
pub struct Outline2ShaderSettings {
