...
const SHADER_ASSET_PATH: &str = "shaders/tint.wgsl";
...
impl Plugin for TintShaderPlugin {
    fn build(&self, app: &mut App) {
        app.register_type::<ShaderSettingsTint>().add_plugins((
            ...
            ExtractComponentPlugin::<ShaderSettingsTint>::default(),
            // The settings will also be the data used in the shader.
            // This plugin will prepare the component for the GPU by creating a uniform buffer
            // and writing the data to that buffer every frame.
            UniformComponentPlugin::<ShaderSettingsTint>::default(),
        ));
...
impl ViewNode for PostProcessNode {
    ...
    type ViewQuery = (
        ...
        &'static ShaderSettingsTint,
        // As there could be multiple post processing components sent to the GPU (one per camera),
        // we need to get the index of the one that is associated with the current view.
        &'static DynamicUniformIndex<ShaderSettingsTint>,
    ...
    fn run(
        ...
        let settings_uniforms = world.resource::<ComponentUniforms<ShaderSettingsTint>>();
        ...
        let layout = render_device.create_bind_group_layout(
            ...
            &BindGroupLayoutEntries::sequential(
                ...
                (
                    ...
                    uniform_buffer::<ShaderSettingsTint>(true),
                    texture_depth_2d(),
                    texture_2d(TextureSampleType::Float { filterable: true }),
